    ...
    <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
      <div className="max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12">
        ...
        <h2 className="max-w-lg mb-6 font-sans text-3xl font-bold leading-none tracking-tight text-gray-900 sm:text-4xl md:mx-auto">
          ...
          tu aprendizaje. Hazte premium!
        </h2>
        <p className="text-base text-gray-700 md:text-lg">
          Mejora tu experiencia. Hazte premium y disfruta de 150 tokens al mes. ¡Únete ahora!
        </p>
      </div>
        ...
        <div className="flex flex-col justify-between p-5 bg-white border rounded shadow-sm">
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li className="flex items-center">
                  ...
                  <p className="font-medium text-gray-800">10 Tokens mensuales*</p>
                </li>
              </ul>
            </div>
          </div>
          <div>
            ...
            <p className="text-sm text-gray-600">
              *Cada Token es una llamada a ChatGPT o una solución de un ejercicio.
            </p>
          </div>
        </div>
        <div className="flex flex-col justify-between p-5 bg-white border rounded shadow-sm">
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li className="flex items-center">
                  ...
                  <p className="font-medium text-gray-800">150 tokens mensuales*</p>
                </li>
              </ul>
            </div>
          </div>
