        ...
        <div className="container mx-auto space-y-16 px-4 py-16 lg:px-8 lg:py-32 xl:max-w-7xl">
          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-2 md:gap-12">
            ...
            <div>
              ...
              <p className="leading-relaxed text-lg text-gray-600 dark:text-gray-400">
                Detrás de MathCampus hay un equipo dedicado de educadores, matemáticos, e ingenieros de software, todos apasionados por hacer que el aprendizaje de las matemáticas sea más accesible y agradable. Trabajamos incansablemente para asegurar que nuestra plataforma sea a la vez innovadora y fácil de usar.
              </p>
            </div>
            <div>
              <h4 className="mb-2 text-lg font-semibold">
